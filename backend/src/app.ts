// The Express app, without a listening socket: src/index.ts serves it locally and on hosts like
// Render; api/index.ts hands it to Vercel as a serverless function.
